...
import bangkit.adhytia.github_user.view.MainActivity
import java.util.*

class AlarmReceiver : BroadcastReceiver() {
    companion object {
        const val ALARM_TIME = "09:00"
        const val ALARM_MESSAGE = "Let's find github users!"
        const val TITLE = "Github Users"
